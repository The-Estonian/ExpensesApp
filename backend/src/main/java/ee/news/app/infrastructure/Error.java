package ee.news.app.infrastructure;
...
public enum Error {
    ...
    ROOM_ROWS_ERROR("The number of rows must be between 2 and 20."),
    ROOM_SEATS_ERROR("The number of seats in a row must be between 2 and 20."),
